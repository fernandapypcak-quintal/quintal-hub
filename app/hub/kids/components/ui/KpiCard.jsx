...
export default function KpiCard({ label, valor, subtitulo, subtituloColor, icon: Icon, delta }) {
  return (
    <div style={{ background: '#fff', border: '1px solid #EBEBEB', borderRadius: 10, padding: '16px 18px', display: 'flex', flexDirection: 'column', gap: 6 }}>
      ...
      {delta && <div style={{ fontSize: 11.5, fontWeight: 600, color: delta.cor }}>{delta.texto}</div>}
    </div>
  )
}
