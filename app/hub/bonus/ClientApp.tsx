...
import { BonusDataProvider } from './hooks/useBonusData'
  ...
  return (
    <div className="min-h-screen bg-surface-base flex flex-col">
      <div className="flex items-center gap-3 px-4 py-2 bg-brand-black border-b border-zinc-800">
        ...
        <span className="text-xs text-zinc-500">Bônus</span>
...
export default function BonusClientApp({ isAdmin = false }: { isAdmin?: boolean }) {
  return (
    <BonusDataProvider isAdmin={isAdmin}>
