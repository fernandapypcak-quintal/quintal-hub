...
import { Plus, Minus, Trash2, Search, Save, X, Flame, TrendingDown, TrendingUp, ChefHat, Upload, FileSpreadsheet, History, PenLine } from 'lucide-react'
...
export default function SimuladorPromocoesClientApp({ allowedLojas = '*', mostrarBarraVoltar = true }) {
  ...
  const precoPromoNum =
    modoPreco === "fixo"
      ? parseFloat((precoFixo || "0").replace(",", "."))
            ...
            <div style={{ background: "#fff", border: "1px solid #E8E8E2", borderRadius: 14, padding: 16 }}>
              ...
              <div style={{ marginBottom: 12 }}>
                ...
                <span style={{ fontSize: 11.5, color: "#9ca3af", marginLeft: 8 }}>
                  Use quando a quantidade acima representa o consumo médio de 1 pessoa (ex: rodízio/all inclusive) — multiplica tudo pelo nº de pessoas do pacote.
                </span>
              </div>
              ...
              {modoPreco === "fixo" ? (
                <div>
                  <label style={label}>Preço do pacote (R$)</label>
                  <input
                    value={precoFixo}
