...
export const DASHBOARDS: Dashboard[] = [
  ...
  },
  {
    ...
    internalPath: '/hub/cmv',
    color: '#8C1414',
    icon: '🏪',
  },
  {
    id: 'turnover',
    name: 'Turnover & Headcount',
    description: 'Gestão de pessoas, turnover e custos com RH',
    url: 'https://turnovereheadcount.vercel.app',
    internalPath: '/hub/turnover',
    color: '#6366f1',
    icon: '👥',
  },
  {
    id: 'marketing',
    name: 'Marketing',
    description: 'Performance de campanhas, ROAS, LTV e ROI',
    url: '',
    internalPath: '/hub/marketing',
    color: '#0ea5e9',
    icon: '📣',
  },
]
...
// Usuários com acesso ao painel de administração
// Separado das permissões de dashboard — ter '*' não garante acesso ao admin
