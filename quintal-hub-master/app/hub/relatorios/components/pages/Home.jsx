...
import { Percent, RotateCcw, Wallet, Gift, Award } from 'lucide-react'

export default function Home() {
  const { descontos, estornos, contasAberto, bonusConcedido, bonusUtilizado } = useRelatorios()
    ...
    <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div>
        ...
        <p style={{ fontSize: 13, color: '#999', marginTop: 4 }}>
          Resumo de descontos, estornos, contas em aberto e bônus — todas as unidades
        </p>
      </div>
